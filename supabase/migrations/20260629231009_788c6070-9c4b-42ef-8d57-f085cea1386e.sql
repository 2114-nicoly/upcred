...
BEGIN
  ...
  -- Valor esperado no caixa = saldo inicial + recebimentos + multas + entradas manuais
  --                           - empréstimos liberados (incluindo renovação/renegociação) - saídas manuais.
  -- Não inclui emprestimo_importado.
  v_expected := v_opening + v_received + v_penalty + v_manual_in - v_lent - v_manual_out;

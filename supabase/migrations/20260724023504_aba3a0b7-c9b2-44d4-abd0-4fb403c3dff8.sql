...
BEGIN
  ...
  -- Dinheiro do trabalhador esperado (referência automática do dia).
  v_expected := (v_received + v_penalty + v_manual_in)
              - (v_lent + v_manual_out + v_expenses);
  -- Dinheiro contado no caixa = valor digitado pelo trabalhador. Se ausente, usa esperado.
  ...
  -- Snapshot imutável. Não altera cash_balance e não cria ajuste.
